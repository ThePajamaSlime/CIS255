...
for (let i = 0; i < reviewers.length; i++) {
	...
	capt = "<caption>" + reviewTitles[i] + "</caption>\n";
	revs = "<tr><th>By</th><td>"          + reviewers[i]         + "</td></tr>\n";
	dats = "<tr><th>Review Date</th><td>" + reviewDates[i]       + "</td></tr>\n";
	strs = "<tr><th>Rating</th><td>"      + starImages(stars[i]) + "</td></tr>\n"; 
	rvse = "<tr><td colspan='2'>" + reviews[i] + "</td></tr>\n";

	reviewCode += capt + revs + dats + strs + rvse + "</table>";
